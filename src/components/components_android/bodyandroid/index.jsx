...
export const Bodyandroid = () => {
    ...
    return (
        <div className='bodysoftapp'
            ...
            <Card onClick={() => { setModalCard1(true) }}
                style={{
                    display: "flex",
                    flexDirection: "column",
                    cursor: "pointer",
                ...
                <Card.Img variant="top" src="https://bgr.com/wp-content/uploads/2020/02/google-android-sign.jpg?quality=82&strip=all"
            ...
            <br />
            <Card onClick={() => { setModalCard2(true) }}
                style={{
                    display: "flex",
                    flexDirection: "column",
                    cursor: "pointer",
                ...
                <Card.Img variant="top" src="https://miro.medium.com/v2/resize:fit:1200/1*S-BNAiYHBfsQb6yw2xZILg.jpeg"
                    style={{ maxHeight: "1000px", maxWidth: "1000px" }} />
                <Card.Body>
                    <Card.Text>
            ...
            <br />
            <Card onClick={() => { setModalCard3(true) }}
                style={{
                    display: "flex",
                    flexDirection: "column",
                    cursor: "pointer",
                ...
                <Card.Img variant="top" src="https://www.pngitem.com/pimgs/m/526-5266159_mobile-app-transparent-background-hd-png-download.png"
                    style={{ maxHeight: "1000px", maxWidth: "1000px" }} />
                <Card.Body>
                    <Card.Text>
                        VANTAGENS EM USAR CELULARES ANDROID
                    </Card.Text>
                </Card.Body>
            </Card>
            {modalCard3 && (
            ...
            <br />
            <Card onClick={() => { setModalCard4(true) }}
                style={{
                    display: "flex",
                    flexDirection: "column",
                    cursor: "pointer",
                ...
                <Card.Img variant="top" src="https://i.pinimg.com/originals/82/5a/1b/825a1b319770e50d19ddb9124c179311.png"
                    style={{ maxHeight: "1000px", maxWidth: "1000px" }} />
                <Card.Body>
                    <Card.Text>
                        FUNÇÕES DESCONHECIDAS DOS CELULARES ANDROID
                    </Card.Text>
                </Card.Body>
            </Card>
            {modalCard4 && (
